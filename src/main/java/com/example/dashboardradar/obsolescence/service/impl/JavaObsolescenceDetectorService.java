...
@Service
public class JavaObsolescenceDetectorService extends AbstractYamlObsolescenceDetectorService {

    public JavaObsolescenceDetectorService(
            ResourceLoader resourceLoader, ObsolescenceMatrixProperties properties, Clock clock) {
        super(resourceLoader, properties.getMatrixBasePath() + "/java.yml", clock);
    }
